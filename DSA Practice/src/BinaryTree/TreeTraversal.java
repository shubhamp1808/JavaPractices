...
public class TreeTraversal {
    ...
    public static List<List<Integer>> preInPostTraversal(Node root) {
        ...
        Stack<Map.Entry<Node, Integer>> st = new Stack<>();
        ...
        while (!st.empty()) {
            Map.Entry<Node, Integer> it = st.pop();
            ...
            if (it.getValue() == 1) {
                ...
                if (it.getKey().left != null) {
                    st.push(new AbstractMap.SimpleEntry<>(it.getKey().left, 1));
                }
            }
            ...
            // this is a part of in
                ...
                if (it.getKey().right != null) {
                    st.push(new AbstractMap.SimpleEntry<>(it.getKey().right, 1));
                }
            }
